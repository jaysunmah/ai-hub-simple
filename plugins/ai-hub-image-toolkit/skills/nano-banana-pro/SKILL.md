...
description: Nano Banana Pro (nano-banana-pro) image generation skill. Use this skill when the user asks to "generate an image", "generate images", "create an image", "make an image", uses "nano banana", or requests multiple images like "generate 5 images". Generates images using Gemini 3 Pro Image for any purpose - frontend designs, web projects, illustrations, graphics, hero images, icons, backgrounds, or standalone artwork. Invoke this skill for ANY image generation request.
allowed-tools: Bash
metadata:
  version: 1.2.1
  tags: e3-verified, image-generation, gemini, ai, frontend, design, graphics
  category: utilities
  status: active
---
...
See @README.md for prerequisites and API key setup.
...
### Step 2: Integrate with Frontend Design (Optional)
...
## Integration with Frontend-Design Skill (Optional)
